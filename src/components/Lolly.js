...
export default function Lolly() {
  return (
    <svg class="lollipop" width="163px" height="431px" viewBox="0 0 163 431" version="1.1" xmlns="http://www.w3.org/2000/svg" >
    <defs>
    ...
    <g id="Page-2" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
        <g id="Lolly">
            ...
            <use class="lollyBottom" fill="#deaa43" fillRule="nonzero" href="#path-1"></use>
            <rect class="lollyTop" fill="#d52358" fillRule="nonzero" mask="url(#mask-2)" x="-25" y="-9" width="224" height="134"></rect>
            <rect class="lollyMiddle" fill="#e95946" fillRule="nonzero" mask="url(#mask-2)" x="-29" y="113" width="224" height="111"></rect>
